...
namespace osu.Game.Rulesets.Mods
{
    ...
    public class ModScoreV2 : Mod
    {
        ...
        public override LocalisableString Description => new TranslatableString((@"osu.Game.Resources.Localisation.RulesetMods:ModScoreV2_description"), @"Score set on earlier osu! versions with the V2 scoring algorithm active.");
