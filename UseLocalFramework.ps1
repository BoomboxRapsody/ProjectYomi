...
(Get-Content "osu.Android.props") -replace "`"..\\ProjectYomi-framework", "`"`$(MSBuildThisFileDirectory)..\ProjectYomi-framework" | Set-Content "osu.Android.props"
(Get-Content "osu.iOS.props") -replace "`"..\\ProjectYomi-framework", "`"`$(MSBuildThisFileDirectory)..\ProjectYomi-framework" | Set-Content "osu.iOS.props"
...
$SLNF.solution.projects += ("../ProjectYomi-framework/osu.Framework/osu.Framework.csproj", "../ProjectYomi-framework/osu.Framework.NativeLibs/osu.Framework.NativeLibs.csproj")
...
$SLNF.solution.projects += ("../ProjectYomi-framework/osu.Framework/osu.Framework.csproj", "../ProjectYomi-framework/osu.Framework.NativeLibs/osu.Framework.NativeLibs.csproj", "../ProjectYomi-framework/osu.Framework.Android/osu.Framework.Android.csproj")
ConvertTo-Json $SLNF | Out-File $TMP -Encoding UTF8
Move-Item -Path $TMP -Destination "osu.Android.slnf" -Force

$SLNF=Get-Content "osu.iOS.slnf" | ConvertFrom-Json
$SLNF.solution.projects += ("../ProjectYomi-framework/osu.Framework/osu.Framework.csproj", "../ProjectYomi-framework/osu.Framework.NativeLibs/osu.Framework.NativeLibs.csproj", "../ProjectYomi-framework/osu.Framework.iOS/osu.Framework.iOS.csproj")
ConvertTo-Json $SLNF | Out-File $TMP -Encoding UTF8
